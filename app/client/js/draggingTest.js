document.addEventListener("DOMContentLoaded", () => {
  ...
  listItems.forEach((item) => {
    ...
    item.addEventListener("click", () => {
      ...
      sprite.width = stackable ? 80 : 40; // Set the width to 80 if stackable, otherwise 40
      sprite.height = stackable ? 80 : 40; // Set the height to 80 if stackable, otherwise 40
